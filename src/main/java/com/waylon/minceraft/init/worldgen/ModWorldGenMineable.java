...
public class ModWorldGenMineable extends WorldGenerator 
{
    ...
    public ModWorldGenMineable(IBlockState state, int blockCount)
    {
        this(state, blockCount, new ModWorldGenMineable.StonePredicate());
    }

    public ModWorldGenMineable(IBlockState state, int blockCount, Predicate<IBlockState> p_i45631_3_)
    {
        this.oreBlock = state;
